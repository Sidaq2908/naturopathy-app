        ...
        <table className='table table-bordered'>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        The information dissemination primarily happens through the Council’s Website. Please click <Link href={`${import.meta.env.BASE_URL}`}>here</Link> to visit the Council’s Website.
                    </td>
                </tr>
                <tr>
                    <td>3.4</td>
                ...
                <tr>
                    ...
                    <td>
                        Annual Report: <a href={`${import.meta.env.BASE_URL}Public_Affairs/Annual_Report_19_20.pdf`}>2019-20</a>, <a href={`${import.meta.env.BASE_URL}Public_Affairs/Annual_Report_20_21.pdf`}>2020-21</a>, <a href={`${import.meta.env.BASE_URL}Public_Affairs/Annual_Report_21_22.pdf`}>2021-22</a>, <a href={`${import.meta.env.BASE_URL}Public_Affairs/Annual_Report_22_23.pdf`}>2022-23</a>, <a href={`${import.meta.env.BASE_URL}Public_Affairs/Annual_Report_23_24.pdf`}>2023-24</a>
                    </td>
                </tr>
                <tr>
                    <td>3.4.1</td>
                ...
                <tr>
                    ...
                    <td rowSpan={2}><a href={`${import.meta.env.BASE_URL}Public_Affairs/Documents_Manuals.xlsx`}>Documents Manual</a></td>
                </tr>
            </tbody>
        </table>
    )
