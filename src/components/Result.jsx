...
function Result() {
    const pdf_titles=[
      ...
      { 
         link:'Result/Research_Officer_203.pdf',
      ...
      { 
         link:'Result/Shortlisted_Companies_for_Pitching_for_YogaTechChallenge2024.pdf',
      ...
      { 
         link:'Result/Junior_Stenographer_(E).pdf',
      ...
      { 
         link:'Result/Result_Notification_for_the_post_of_RO_(Y&N).pdf',
      ...
      { 
         link:'Result/Result_Notification_for_the_post_of_RO_(CP).pdf',
      ...
      { 
         link:'Result/Result_Notification_for_the_post_of_RO_(LS).pdf', 
      ...
      { 
         link:'Result/Result_Notification_for_the_post_of_RO_(NP).pdf',
      ...
      { 
         link:'Result/Result_Notification_for_the_post_of_Medical_Officer_(Allopathy).pdf',
      ...
      { 
         link:'Result/Result_Notification_for_the_post_of_Statistical_Assistant.pdf',
      ...
      { 
         link:'Result/Result_Notification_for_the_post_of_Accountant.pdf',
      ...
      { 
         link:'Result/Result_Notification_for_the_post_of_MTS.pdf',
